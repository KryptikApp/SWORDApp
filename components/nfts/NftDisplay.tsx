    ...
    <div id="" className="">
      ...
      <Modal isOpen={showModal} onRequestClose={handleModalClose} dark={isDark}>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div
            id={nftCardId}
            className="flex-1 bg-[#F2FBFE] dark:bg-black md:ml-6 mt-8 md:mt-0 rounded-lg min-h-[30rem] md:min-h-[25rem] h-fit md:max-h-[40rem] dark:border dark:border-gray-100 md:overflow-x-hidden overflow-y-auto no-scrollbar"
          >
