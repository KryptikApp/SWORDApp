    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <button
            type="button"
            className="md:hidden mb-2 mt-4 mr-4 text-black bg-[#F2FBFE] rounded-full font-bold text-sm p-1.5 ml-auto items-center dark:bg-[#F2FBFE] dark:text-black transition ease-in-out hover:scale-110"
            onClick={() => onRequestClose()}
          >
            <svg
              className="w-5 h-5"
