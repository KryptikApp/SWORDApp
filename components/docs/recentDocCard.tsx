...
const RecentDocCard = ({ doc, baseUrl }: Props) => {
  ...
  return (
    <div className="mx-auto w-full">
      <div className="rounded-lg bg-[#F2FBFE] dark:bg-gray-900 text-black dark:text-white outline outline-1 outline-gray-500 hover:outline-green-400 min-h-[300px] md:min-h-[500px]">
